...
public enum RegisterFile {
	...
	BRESLAU_VIII_BIRTH("22", "breslau_8_birth", "Geburtsregister Breslau VIII (Pilsnitz, Masselwitz)"),
	BRESLAU_VIII_MARRIAGE("23", "breslau_8_marriage", "Heiratsregister Breslau VIII (Pilsnitz, Masselwitz)"),
	BRESLAU_VIII_DEATH("24", "breslau_8_death", "Sterberegister Breslau VIII (Pilsnitz, Masselwitz)"),
